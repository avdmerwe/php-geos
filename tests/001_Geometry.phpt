...
class GeometryTest extends GEOSTest
{
    ...
    public function testGeometry_offsetCurve()
    {
        ...
        $this->assertEquals('LINESTRING (0 -10, 100 -10, 102 -10, 104 -9, 106 -8, 107 -7, 108 -6, 109 -4, 110 -2, 110 0, 110 100)', $writer->write($b));
    ...
    public function testGeometry_isClosed()
    {
        ...
        try  {
            ...
            $this->assertContains('Curve', $e->getMessage());
        }
    ...
    public function testGeometry_numInteriorRings()
    {
        ...
        try {
            ...
            $this->assertContains( 'Surface', $e->getMessage() );
        }
    ...
    public function testGeometry_numPoints()
    {
        ...
        try {
            ...
            $this->assertContains( 'SimpleCurve', $e->getMessage() );
        }
